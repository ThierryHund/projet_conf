$.get( "http://localhost/webprojet/projet_conf/projet_conf/server/controler_admin.php",'consulter_evenement',function( data ) {
   $.each(data, function() {
	    $('.infoEvent').append(
	        ...
	        +'<div class="btn-group"><button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown"> Action <span class="caret" ></span></button> <ul class="dropdown-menu" role="menu"> <li><a href="consulter_presentation.html?id_event='+this.id+'">Consulter</a></li><li><a href="modifier_evenement.html?id_event='+this.id+'">Editer</a></li> <li class="divider"></li> <li><a href="#" id="supprEvnt">Supprimer</a></li> </ul></div>'
	        +'</td></tr>'
